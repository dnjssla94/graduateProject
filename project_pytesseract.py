...
class Recognition:
     def textRecognition(self, img):
          # Number='/Users/shinwonkim/Desktop/graduateProject/image/detectedCar3.jpg' 
          # img=cv2.imread(image,cv2.IMREAD_COLOR)
          copy_img=img.copy()

          # shape = img.shape
          # h = round(shape[0]/2)
          # img = img[h:shape[0],0:shape[1]]

          img2=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
          # cv2.imshow('gray.jpg',img2)
...
# Number='/Users/shinwonkim/Desktop/graduateProject/image/detectedCar0.jpg' 
# img=cv2.imread(Number,cv2.IMREAD_COLOR)
# plate=Recognition()
# result=plate.textRecognition(img)
# print(type(result))
# print(result)
